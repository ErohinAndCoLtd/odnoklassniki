// ==UserScript==
// @name        Automatic cunt licker w cities
...
var initialWaitTime = 5000,
    ...
    cityList = [ "Москва", "Санкт-Петербург", "Нижний Новгород", "Екатеринбург", "Челябинск" ],
    phraseList = [  "Красота!",
                    "Секси!",
                    "Ты очень красивая :)",
                    "Офигенная фотка!",
...
function doScript() {
  var cityLink = document.getElementById ("onSiteNowCityLink"),
      cityEditField,
